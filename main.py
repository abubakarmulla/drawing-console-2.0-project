...
class Window(QMainWindow):
    def __init__(self):
        ...
        magenta = QAction("Pink", self)
        b_color.addAction(magenta)
        magenta.triggered.connect(self.magentaColor)

        # method for checking mouse cicks
        # this method is present in QMainWindow class
        # we have overrided this method based on our implementation
...
"""
# simple paint app using tkinter library
from tkinter import *
root = Tk()
